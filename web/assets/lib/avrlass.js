...
const AVRLASS = new function () {
    ...
    function eval_scoped(js, context) {
        // Create an array of context property names
        const contextKeys = Object.keys(context);
        
        // Create an array of context values
        const contextValues = contextKeys.map(key => context[key]);
        
        // Create a function that takes the context values as parameters
        ...
        return evaluator.apply(null, contextValues);
    }
